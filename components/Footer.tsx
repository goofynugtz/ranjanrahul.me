  ...
  return (
    <footer className='footer'>
      ...
      <div className='group'>
        ...
        <div className='social sm:hide'><a href="https://facebook.com" target="_blank" rel="noreferrer"><FaFacebookF /></a></div>
        <div className='social sm:hide'><a href="https://github.com/goofyNugtz" target="_blank" rel="noreferrer"><FaGithub /></a></div>
        <div className='social sm:hide'><Link href="/" passHref><FaLinkedinIn /></Link></div>
